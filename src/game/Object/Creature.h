...
class Creature : public Unit
{
    ...
    public:
        ...
        */
        ...
        bool IsDamageEnoughForLootingAndReward() const { return m_PlayerDamageReq == 0; }//Ìí¼Ó´úÂëÐÞ¸´ÉËº¦³¬¹ý50%²ÅÓÐµôÂä
        void LowerPlayerDamageReq(uint32 unDamage);//Ìí¼Ó´úÂëÐÞ¸´ÉËº¦³¬¹ý50%²ÅÓÐµôÂä
        void ResetPlayerDamageReq() { m_PlayerDamageReq = GetHealth() / 2; }//Ìí¼Ó´úÂëÐÞ¸´ÉËº¦³¬¹ý50%²ÅÓÐµôÂä
        ...
        */
        ...
        void RemoveCorpse(bool inPlace = false);//Ìí¼Ó´úÂëÐÞ¸´Ñ±»¯Ï¡ÓÐ³èÎïå´»ú
    ...
    protected:
        ...
        uint32 m_PlayerDamageReq;//Ìí¼Ó´úÂëÐÞ¸´ÉËº¦³¬¹ý50%²ÅÓÐµôÂä
