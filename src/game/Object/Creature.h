...
class Creature : public Unit
{
    ...
    public:
        ...
        */
        ...
        bool IsDamageEnoughForLootingAndReward() const { return m_PlayerDamageReq == 0; }//ÃÌº”µÙ¬‰–ﬁ∏¥50%…À∫¶µÙ¬‰
        void LowerPlayerDamageReq(uint32 unDamage);//ÃÌº”µÙ¬‰–ﬁ∏¥50%…À∫¶µÙ¬‰
        void ResetPlayerDamageReq() { m_PlayerDamageReq = GetHealth() / 2; }//ÃÌº”µÙ¬‰–ﬁ∏¥50%…À∫¶µÙ¬‰
...
//…æ≥˝¥˙¬Î–ﬁ∏¥—±ªØœ°”–≥ËŒÔÂ¥ª˙        void RemoveCorpse();
        void RemoveCorpse(bool inPlace = false);//ÃÌº”¥˙¬Î–ﬁ∏¥—±ªØœ°”–≥ËŒÔÂ¥ª˙
    ...
    protected:
        ...
        uint32 m_PlayerDamageReq;//ÃÌº”¥˙¬Î–ﬁ∏¥50%…À∫¶µÙ¬‰
