...
//É¾³ý´íÎóµÄ´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï            GetNearPoint(obj, x, y, z, bounding_radius, distance2d + GetObjectBoundingRadius() + bounding_radius, GetOrientation() + angle);
            GetNearPoint(obj, x, y, z, bounding_radius, distance2d, GetOrientation() + angle);//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
        }
