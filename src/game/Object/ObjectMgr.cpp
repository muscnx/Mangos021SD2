...
bool PlayerCondition::Meets(Player const* player, Map const* map, WorldObject const* source, ConditionSource conditionSourceType) const
{
    ...
    switch (m_condition)
    {
        ...
        case CONDITION_GAMEOBJECT_IN_RANGE:
        {
            ...
            if (source)//Ìí¼Ó´úÂëÐÞ¸´å´»ú
            {//Ìí¼Ó´úÂëÐÞ¸´å´»ú
                MaNGOS::NearestGameObjectEntryInObjectRangeCheck go_check(*source, m_value1, m_value2);//Ìí¼Ó´úÂëÐÞ¸´å´»ú
                MaNGOS::GameObjectLastSearcher<MaNGOS::NearestGameObjectEntryInObjectRangeCheck> searcher(pGo, go_check);//Ìí¼Ó´úÂëÐÞ¸´å´»ú

                Cell::VisitGridObjects(source, searcher, m_value2);//Ìí¼Ó´úÂëÐÞ¸´å´»ú
            }//Ìí¼Ó´úÂëÐÞ¸´å´»ú
            return pGo;
        }
        default:
