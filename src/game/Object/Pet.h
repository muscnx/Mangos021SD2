...
enum PetDatabaseStatus//ÃÌº”¥˙¬Î–ﬁ∏¥¡‘»À’ŸªΩÀ¿Õˆµƒ≥ËŒÔ
{//ÃÌº”¥˙¬Î–ﬁ∏¥¡‘»À’ŸªΩÀ¿Õˆµƒ≥ËŒÔ
    PET_DB_NO_PET       = 0,//ÃÌº”¥˙¬Î–ﬁ∏¥¡‘»À’ŸªΩÀ¿Õˆµƒ≥ËŒÔ
    PET_DB_DEAD         = 1,//ÃÌº”¥˙¬Î–ﬁ∏¥¡‘»À’ŸªΩÀ¿Õˆµƒ≥ËŒÔ
    PET_DB_ALIVE        = 2,//ÃÌº”¥˙¬Î–ﬁ∏¥¡‘»À’ŸªΩÀ¿Õˆµƒ≥ËŒÔ
};//ÃÌº”¥˙¬Î–ﬁ∏¥¡‘»À’ŸªΩÀ¿Õˆµƒ≥ËŒÔ
...
class Pet : public Creature
{
    public:
        ...
        static PetDatabaseStatus GetStatusFromDB(Player*);//ÃÌº”¥˙¬Î–ﬁ∏¥¡‘»À’ŸªΩÀ¿Õˆµƒ≥ËŒÔ
