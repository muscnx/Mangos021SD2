...
//É¾³ý´íÎóµÄ´úÂëÐÞ¸´¸´»îÖ»ÄÜÔÚ¸±±¾        if (IsDead())   // rare case of teleporting the player into an instance with no areatrigger participation
        if (IsDead() && mEntry->IsDungeon())    // rare case of teleporting the player into an instance with no areatrigger participation//Ìí¼Ó´úÂëÐÞ¸´¸´»îÖ»ÄÜÔÚ¸±±¾
        {
...
//É¾³ý´íÎóµÄ´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï            if (pet && !pet->IsWithinDist3d(x, y, z, GetMap()->GetVisibilityDistance()))
//É¾³ý´íÎóµÄ´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï                { UnsummonPetTemporaryIfAny(); }
            if (pet)//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
            {//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
                if (!pet->IsWithinDist3d(x, y, z, GetMap()->GetVisibilityDistance()))//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
                {//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
                    if (pet->IsAlive())//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
                    {//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
                        UnsummonPetTemporaryIfAny();//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
                    }//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
                    else//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
                    {//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
                        pet->Unsummon(PET_SAVE_NOT_IN_SLOT);//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
                        pet = GetPet();//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
                    }//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
                }//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
            }//Ìí¼Ó´úÂëÐÞ¸´ÁÔÈËÕÙ»½ËÀÍöµÄ³èÎï
        }
...
{
//É¾³ý´íÎóµÄ´úÂë    float value = (m_auraBaseMod[SHIELD_BLOCK_VALUE][FLAT_MOD] + GetStat(STAT_STRENGTH) / 20 - 1) * m_auraBaseMod[SHIELD_BLOCK_VALUE][PCT_MOD];
    float value = (m_auraBaseMod[SHIELD_BLOCK_VALUE][FLAT_MOD] + GetStat(STAT_STRENGTH) / 0.5f - 10) * m_auraBaseMod[SHIELD_BLOCK_VALUE][PCT_MOD]; //Ìí¼Ó´úÂëÇ¿»¯¶ÜÅÆ¸ñµ²
...
{
//É¾³ý´úÂëÐÞ¸´50%ÉËº¦    /* Nobody tapped the monster (solo kill by another NPC) */
//É¾³ý´úÂëÐÞ¸´50%ÉËº¦    if (!creature->HasFlag(UNIT_DYNAMIC_FLAGS, UNIT_DYNFLAG_TAPPED))
    /* Nobody tapped the monster (kill either solo or mostly by another NPC) *///Ìí¼Ó´úÂëÐÞ¸´50%ÉËº¦µôÂä
    if (!creature->HasFlag(UNIT_DYNAMIC_FLAGS, UNIT_DYNFLAG_TAPPED) || !creature->IsDamageEnoughForLootingAndReward())//Ìí¼Ó´úÂëÐÞ¸´50%ÉËº¦µôÂä
	        { return false; }
