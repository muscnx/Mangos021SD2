...
struct SpellEntry
{
        ...
        */
        ...
        inline bool HasSpellEffect(SpellEffects effect) const //Ìí¼Ó´úÂëÐÞ¸´·çÅ­ÎäÆ÷
        { //Ìí¼Ó´úÂëÐÞ¸´·çÅ­ÎäÆ÷
            for (uint8 i = EFFECT_INDEX_0; i <= EFFECT_INDEX_2; ++i) //Ìí¼Ó´úÂëÐÞ¸´·çÅ­ÎäÆ÷
                if (Effect[i] == effect) //Ìí¼Ó´úÂëÐÞ¸´·çÅ­ÎäÆ÷
                    return true; //Ìí¼Ó´úÂëÐÞ¸´·çÅ­ÎäÆ÷
            return false; //Ìí¼Ó´úÂëÐÞ¸´·çÅ­ÎäÆ÷
        } //Ìí¼Ó´úÂëÐÞ¸´·çÅ­ÎäÆ÷
