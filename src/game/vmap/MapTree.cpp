        ...
        if (tf)
        {
            ...
            for (uint32 i = 0; i < numSpawns && result; ++i)
            {
                ...
                if (result)
                {
                    ...
                    {
//É¾³ý´úÂëÐÞ¸´vmapµØÍ¼µ¼ÖÂå´»ú#ifdef VMAP_DEBUG
                        if (referencedVal > iNTreeValues)
                        {
//É¾³ý´úÂëÐÞ¸´vmapµØÍ¼µ¼ÖÂå´»ú                            DEBUG_LOG("invalid tree element! (%u/%u)", referencedVal, iNTreeValues);
                            ERROR_LOG("invalid tree element! (%u/%u)", referencedVal, iNTreeValues);//Ìí¼Ó´úÂëÐÞ¸´vmapµØÍ¼µ¼ÖÂå´»ú
                            continue;
                        }
//É¾³ý´úÂëÐÞ¸´vmapµØÍ¼µ¼ÖÂå´»ú#endif
